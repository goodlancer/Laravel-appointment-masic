    ...
    'env'=>[
        [
            ...
            'fields'=>[
                ...
                ["title"=>"App debuging",'key'=>'APP_DEBUG','value'=>'true', 'ftype'=>'bool',"help"=>"Enable if you experince error 500"],
                ...
                ["title"=>"Driver percent from the order",'help'=>"From 0-100. Based on your bussiness type, this value determines how much driver will make from the delivery fee",'key'=>'DRIVER_PERCENT_FROM_DELIVERY_FEE','value'=>'100','onlyin'=>"ft"],

                ["separator"=>"Other settings","title"=>"Minimum phone numner length",'key'=>'MIN_PHONE_NUMBER','value'=>9, 'type'=>'number'],
                ...
                ["title"=>"Print templates zip","help"=>"Link to .zip representing the template for download. You can usae remote file",'key'=>'linkToTemplates','value'=>"/impactfront/img/templates.zip",'onlyin'=>"qrsaas"],
        ...
        [
            ...
            'fields'=>[
                ...
                ["title"=>"Money convertion",'help'=>"Some currencies need this field to be unselected. By default it should be selected",'key'=>'DO_CONVERTION','value'=>'true','ftype'=>"bool"],
        ...
        [
            ...
            'icon'=>"ni ni-ui-04",
            'fields'=>[
                ["separator"=>"Google plugins","title"=>"Recaptha site key",'help'=>"Make empty if you can't make submition on register screen",'key'=>'RECAPTCHA_SITE_KEY','value'=>''],
                ["title"=>"Recaptha secret",'help'=>"Make empty if you can't make submition on register screen",'key'=>'RECAPTCHA_SECRET_KEY','value'=>''],
        ...
        [
            ...
            'icon'=>"ni ni-email-83",
            'fields'=>[
                ["title"=>"Mail driver",'key'=>'MAIL_DRIVER','value'=>'smtp','ftype'=>"select",'data'=>['smtp'=>"SMTP",'sendmail'=>"PHP Sendmail - best of port 465"]],
